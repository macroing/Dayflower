...
final Material material9 = new MatteMaterial();
...
final Shape3F shape9 = new Sphere3F();
...
final Transform transform9 = new Transform(new Point3F( 0.0F, 5.5F,  7.0F));

final AreaLight areaLight9 = new DiffuseAreaLight(transform9, 1, new Color3F(12.0F), shape9, true);
...
final Primitive primitive9 = new Primitive(material9, shape9, transform9, areaLight9);
