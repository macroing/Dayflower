...
if(isInBox) {
	...
	scene.addPrimitive(new Primitive(material22, shape22, new ConstantTexture(), new ConstantTexture(), transform21));
	scene.addPrimitive(new Primitive(material23, shape23, new ConstantTexture(), new ConstantTexture(), transform21));
	scene.addPrimitive(new Primitive(material24, shape24, new ConstantTexture(), new ConstantTexture(), transform21));
	scene.addPrimitive(new Primitive(material25, shape25, new ConstantTexture(), new ConstantTexture(), transform21));
	scene.addPrimitive(new Primitive(material26, shape26, new ConstantTexture(), new ConstantTexture(), transform21));
	scene.addPrimitive(new Primitive(material27, shape27, new ConstantTexture(), new ConstantTexture(), transform21));
	scene.addPrimitive(new Primitive(material28, shape28, new ConstantTexture(), new ConstantTexture(), transform21));
