...
Texture textureHjul = ImageTexture.load("./resources/textures/hjul.png", AngleF.degrees(0.0F), new Vector2F(1.0F, 1.0F));
...
Material material21 = new PlasticPBRTMaterial(textureTextur, new ConstantTexture(new Color3F(0.2F)), new ConstantTexture(Color3F.WHITE), true);
Material material22 = new SubstratePBRTMaterial(textureHjul, new ConstantTexture(new Color3F(0.2F)), new ConstantTexture(new Color3F(0.2F)), new ConstantTexture(new Color3F(0.2F)), true);
Material material23 = new SubstratePBRTMaterial(textureHjul, new ConstantTexture(new Color3F(0.2F)), new ConstantTexture(new Color3F(0.2F)), new ConstantTexture(new Color3F(0.2F)), true);
Material material24 = new SubstratePBRTMaterial(textureHjul, new ConstantTexture(new Color3F(0.2F)), new ConstantTexture(new Color3F(0.2F)), new ConstantTexture(new Color3F(0.2F)), true);
Material material25 = new SubstratePBRTMaterial(textureHjul, new ConstantTexture(new Color3F(0.2F)), new ConstantTexture(new Color3F(0.2F)), new ConstantTexture(new Color3F(0.2F)), true);
