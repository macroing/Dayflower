Material material1 = new MatteMaterial(new ConstantTexture(new Color3F(20.0F)), /*new ConstantTexture(Color3F.GRAY)*/new SimplexFractionalBrownianMotionTexture());
