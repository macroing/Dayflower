...
Material material2 = new SubstrateMaterial(new ConstantTexture(new Color3F(0.5F, 0.5F, 0.5F)), new ConstantTexture(new Color3F(0.1F)), new ConstantTexture(new Color3F(0.1F)), new ConstantTexture(new Color3F(1.0F)), true);
...
scene.setName("PBRTShowcaseMaterialSubstrateMaterial");