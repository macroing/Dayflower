...
Matrix44F matrix21 = Matrix44F.multiply(Matrix44F.multiply(Matrix44F.translate(0.0F, 2.0F, 5.0F), Matrix44F.rotateY(AngleF.degrees(180.0F))), Matrix44F.scale(0.02F));
Matrix44F matrix31 = Matrix44F.translate(0.0F, 8.0F, 0.0F);

AreaLight areaLight = new DiffuseAreaLight(matrix31, 1, new Color3F(50.0F), shape31, false);
...
scene.addPrimitive(new Primitive(material31, shape31, new ConstantTexture(), new ConstantTexture(), matrix31, areaLight));
