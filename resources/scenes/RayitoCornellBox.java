...
Material material09 = new MatteRayitoMaterial(Color3F.WHITE, /*Color3F.BLACK*/new Color3F(12.0F));
...
Transform transform01 = new Transform(new Point3F( 0.0F, 0.00F,  0.0F));
Transform transform02 = new Transform(new Point3F( 0.0F, 5.00F,  0.0F));
Transform transform03 = new Transform(new Point3F( 0.0F, 0.00F,  0.0F));
Transform transform04 = new Transform(new Point3F( 0.0F, 0.00F, 10.0F));
Transform transform05 = new Transform(new Point3F( 3.0F, 0.00F,  0.0F));
