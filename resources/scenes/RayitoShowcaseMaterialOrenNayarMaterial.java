...
Material material2 = new OrenNayarMaterial(AngleF.degrees(90.0F));

Shape3F shape1 = new Plane3F();
Shape3F shape2 = new Sphere3F(10.0F);

Texture texture11 = new ConstantTexture(Color3F.WHITE);
Texture texture12 = new ConstantTexture();
Texture texture21 = new ConstantTexture(Color3F.GRAY);
...
scene.setName("RayitoShowcaseMaterialOrenNayarMaterial");