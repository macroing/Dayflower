...
Material material0 = new LambertianMaterial();
Material material1 = new AshikhminShirleyMaterial();
...
scene.addPrimitive(new Primitive(material0, shape0, new ConstantTexture(Color3F.GRAY), new ConstantTexture(), matrix0));
scene.addPrimitive(new Primitive(material1, shape1, FunctionTexture.createShapeIdentity(shapeA, new ConstantTexture(new Color3F(1.0F, 0.1F, 0.1F)), shapeB, new ConstantTexture(new Color3F(0.1F, 1.0F, 0.1F))), new ConstantTexture(), matrix1));
scene.setCamera(new Camera(new Point3F(0.0F, 4.0F, -10.0F), AngleF.degrees(40.0F)));
scene.setName("RayitoShowcaseShape3FConstructiveSolidGeometry3F");