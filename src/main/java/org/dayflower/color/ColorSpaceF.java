...
/**
 * A {@code ColorSpaceF} represents a color space using the data type {@code float}.
 * <p>
 * An instance of this class can convert {@link Color3F} and {@link Color4F} instances from a specific RGB color space to a specific XYZ color space, as well as from a specific XYZ color space to a specific RGB color space. In addition to that, it can
