 ...
 */
public interface BoundingVolume3FReader {
	/**
	...
	/**
	 * Returns {@code true} if, and only if, this {@code BoundingVolume3FReader} instance supports reading {@link BoundingVolume3F} instances with an ID of {@code id}, {@code false} otherwise.
	 * 
	 * @param id the ID of the {@code BoundingVolume3F} type to check
	 * @return {@code true} if, and only if, this {@code BoundingVolume3FReader} instance supports reading {@code BoundingVolume3F} instances with an ID of {@code id}, {@code false} otherwise
	 */
