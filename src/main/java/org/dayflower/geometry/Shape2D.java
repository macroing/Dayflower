 ...
 */
public interface Shape2D extends Node {
	/**
	 * Returns a {@code String} with the name of this {@code Shape2D} instance.
	 * 
	 * @return a {@code String} with the name of this {@code Shape2D} instance
	 */
	String getName();
	
	/**
	 * Returns an {@code int} with the ID of this {@code Shape2D} instance.
	 * 
	 * @return an {@code int} with the ID of this {@code Shape2D} instance
	 */
	int getID();
	
	/**
	 * Writes this {@code Shape2D} instance to {@code dataOutput}.
	 * <p>
	...
	/**
	 * Writes this {@code Shape2D} instance to the file represented by {@code file}.
	 * <p>
	...
	/**
	 * Writes this {@code Shape2D} instance to the file represented by {@code pathname}.
	 * <p>
