...
public final class Triangle3F implements Shape3F {
	...
	/**
	 * Performs an intersection test between {@code mutableSurfaceIntersection} and this {@code Triangle3F} instance.
	 * <p>
	 * Returns {@code true} if, and only if, {@code mutableSurfaceIntersection} intersects this {@code Triangle3F} instance, {@code false} otherwise.
	 * <p>
	 ...
	 * @return {@code true} if, and only if, {@code mutableSurfaceIntersection} intersects this {@code Triangle3F} instance, {@code false} otherwise
	 ...
	 * 
	 * @param ray the {@link Ray3F} to perform an intersection test against this {@code Triangle3F} instance
	 * @return {@code true} if, and only if, {@code ray} intersects this {@code Triangle3F} instance, {@code false} otherwise
	 * @throws NullPointerException thrown if, and only if, {@code ray} is {@code null}
	 */
	@Override
