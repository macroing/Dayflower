...
//	TODO: Add Unit Tests!
	public static FloatImageF createScreenCapture(final Rectangle2I rectangle) {
		return new FloatImageF(BufferedImages.createScreenCapture(rectangle.getA().x, rectangle.getA().y, rectangle.getC().x - rectangle.getA().x, rectangle.getC().y - rectangle.getA().y));
	}
