...
//	TODO: Add Unit Tests!
	public static PixelImageD createScreenCapture(final Rectangle2I rectangle) {
		return new PixelImageD(BufferedImages.createScreenCapture(rectangle.getA().x, rectangle.getA().y, rectangle.getC().x - rectangle.getA().x, rectangle.getC().y - rectangle.getA().y));
	}
...
//	TODO: Add Unit Tests!
	...
	/**
	 * Loads a {@code PixelImageD} from the URL represented by {@code uRL}.
	 * <p>
	 * Returns a new {@code PixelImageD} instance.
	 * <p>
...
//	TODO: Add Unit Tests!
	 ...
	 * @author J&#246;rgen Lundgren
	 */
	public static final class PixelD {
