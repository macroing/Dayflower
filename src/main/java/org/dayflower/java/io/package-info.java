/**
 * Provides the Java I/O API.
 * <p>
 * The Java I/O API is an extension to {@code java.io}.
 * <h3>Overview</h3>
 * <p>
 ...
 * <ul>
 * <li>{@link org.dayflower.java.io.Files Files} consists exclusively of static methods that returns or performs various operations on {@code File} instances.</li>
 * </ul>
 */
