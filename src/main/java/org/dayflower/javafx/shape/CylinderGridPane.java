...
/**
 * A {@code CylinderGridPane} is a {@link ShapeGridPane} for {@link Cylinder3F} creation.
 * 
 * @since 1.0.0
 * @author J&#246;rgen Lundgren
 */
public final class CylinderGridPane extends ShapeGridPane {
	...
	/**
	 * Constructs a new {@code CylinderGridPane} instance.
	 */
	public CylinderGridPane() {
		...
		this.textFieldZMin = TextFields.createTextField(-1.0F);
	...
	/**
	 * Returns a {@link Cylinder3F} instance.
	 * 
	 * @return a {@code Cylinder3F} instance
	 */
	@Override
	public Shape3F createShape() {
		return new Cylinder3F(doGetPhiMax(), doGetRadius(), doGetZMax(), doGetZMin());
	}
