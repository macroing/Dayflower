...
public final class TorranceSparrowPBRTBTDF extends PBRTBXDF {
	...
	/**
	 * Constructs a new {@code TorranceSparrowPBRTBTDF} instance.
	 * <p>
	 ...
	 */
	public TorranceSparrowPBRTBTDF(final Color3F transmittanceScale, final MicrofacetDistribution microfacetDistribution, final TransportMode transportMode, final float etaA, final float etaB) {
...
//		PBRT: Implementation of MicrofacetTransmission.
	...
	/**
	 * Returns a {@code String} representation of this {@code TorranceSparrowPBRTBTDF} instance.
	 * 
	 * @return a {@code String} representation of this {@code TorranceSparrowPBRTBTDF} instance
	 */
	@Override
	public String toString() {
		return String.format("new TorranceSparrowPBRTBTDF(%s, %s, %s, %+.10f, %+.10f)", this.transmittanceScale, this.microfacetDistribution, this.transportMode, Float.valueOf(this.etaA), Float.valueOf(this.etaB));
	}
	
	/**
	 * Compares {@code object} to this {@code TorranceSparrowPBRTBTDF} instance for equality.
	 * <p>
	 * Returns {@code true} if, and only if, {@code object} is an instance of {@code TorranceSparrowPBRTBTDF}, and their respective values are equal, {@code false} otherwise.
	 * 
	 * @param object the {@code Object} to compare to this {@code TorranceSparrowPBRTBTDF} instance for equality
	 * @return {@code true} if, and only if, {@code object} is an instance of {@code TorranceSparrowPBRTBTDF}, and their respective values are equal, {@code false} otherwise
	 */
	@Override
	public boolean equals(final Object object) {
		if(object == this) {
			return true;
		} else if(!(object instanceof TorranceSparrowPBRTBTDF)) {
			return false;
		} else if(!Objects.equals(this.transmittanceScale, TorranceSparrowPBRTBTDF.class.cast(object).transmittanceScale)) {
			return false;
		} else if(!Objects.equals(this.fresnel, TorranceSparrowPBRTBTDF.class.cast(object).fresnel)) {
			return false;
		} else if(!Objects.equals(this.microfacetDistribution, TorranceSparrowPBRTBTDF.class.cast(object).microfacetDistribution)) {
			return false;
		} else if(!Objects.equals(this.transportMode, TorranceSparrowPBRTBTDF.class.cast(object).transportMode)) {
			return false;
		} else if(!equal(this.etaA, TorranceSparrowPBRTBTDF.class.cast(object).etaA)) {
			return false;
		} else if(!equal(this.etaB, TorranceSparrowPBRTBTDF.class.cast(object).etaB)) {
			return false;
		} else {
			return true;
		}
...
//		PBRT: Implementation of MicrofacetTransmission.
	...
	/**
	 * Returns a hash code for this {@code TorranceSparrowPBRTBTDF} instance.
	 * 
	 * @return a hash code for this {@code TorranceSparrowPBRTBTDF} instance
	 */
	@Override
	public int hashCode() {
