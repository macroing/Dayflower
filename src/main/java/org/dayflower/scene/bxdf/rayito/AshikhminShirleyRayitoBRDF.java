 ...
 */
public final class AshikhminShirleyRayitoBRDF implements RayitoBXDF {
	 ...
	 * <pre>
	 * {@code
	 * ashikhminShirleyRayitoBRDF.evaluateSolidAngle(o, n, i, false);
	 * }
	 * </pre>
	 * 
	 ...
	 * <pre>
	 * {@code
	 * ashikhminShirleyRayitoBRDF.sampleSolidAngle(o, n, orthonormalBasis, u, v, false);
	 * }
	 * </pre>
	 * 
	 * @param o a {@link Vector3F} instance with the outgoing direction from the surface intersection point to the origin of the ray
	...
	/**
	 * Returns {@code true} if, and only if, this {@code AshikhminShirleyRayitoBRDF} instance is using a Dirac distribution, {@code false} otherwise.
	 * <p>
	 * This method always returns {@code false}.
	 * 
	 * @return {@code true} if, and only if, this {@code AshikhminShirleyRayitoBRDF} instance is using a Dirac distribution, {@code false} otherwise
	 */
	@Override
	 ...
	 * <pre>
	 * {@code
	 * ashikhminShirleyRayitoBRDF.probabilityDensityFunctionSolidAngle(o, n, i, false);
	 * }
	 * </pre>
	 * 
	 * @param o a {@link Vector3F} instance with the outgoing direction from the surface intersection point to the origin of the ray
