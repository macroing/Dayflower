...
public final class CompiledCameraCache {
	...
	public static float[] toCamera(final Camera camera) {
		...
		array[CAMERA_OFFSET_ORTHONORMAL_BASIS_U + 0] = orthonormalBasis.getU().x;
		array[CAMERA_OFFSET_ORTHONORMAL_BASIS_U + 1] = orthonormalBasis.getU().y;
		array[CAMERA_OFFSET_ORTHONORMAL_BASIS_U + 2] = orthonormalBasis.getU().z;
		array[CAMERA_OFFSET_ORTHONORMAL_BASIS_V + 0] = orthonormalBasis.getV().x;
		array[CAMERA_OFFSET_ORTHONORMAL_BASIS_V + 1] = orthonormalBasis.getV().y;
		array[CAMERA_OFFSET_ORTHONORMAL_BASIS_V + 2] = orthonormalBasis.getV().z;
		array[CAMERA_OFFSET_ORTHONORMAL_BASIS_W + 0] = orthonormalBasis.getW().x;
		array[CAMERA_OFFSET_ORTHONORMAL_BASIS_W + 1] = orthonormalBasis.getW().y;
		array[CAMERA_OFFSET_ORTHONORMAL_BASIS_W + 2] = orthonormalBasis.getW().z;
