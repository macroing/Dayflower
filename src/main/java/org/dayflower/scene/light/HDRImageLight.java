...
/**
 * An {@code HDRImageLight} is a {@link Light} implementation backed by a high-dynamic-range (HDR) image.
 * <p>
 ...
 */
public final class HDRImageLight extends Light {
	/**
	 * The name of this {@code HDRImageLight} class.
	 */
	public static final String NAME = "HDR Image Light";
	
	/**
	 * The ID of this {@code HDRImageLight} class.
	 */
	...
	/**
	 * Constructs a new {@code HDRImageLight} instance.
	 * <p>
	 ...
	 * <pre>
	 * {@code
	 * new HDRImageLight(image, AngleF.degrees(0.0F));
	 * }
	 * </pre>
	 * 
	 ...
	 */
	public HDRImageLight(final ImageF image) {
	 ...
	 * <pre>
	 * {@code
	 * new HDRImageLight(image, angle, new Vector2F(1.0F, 1.0F));
	 * }
	 * </pre>
	 * 
	 * @param image an {@link ImageF} instance
	 ...
	 */
	public HDRImageLight(final ImageF image, final AngleF angle) {
	 ...
	 * <pre>
	 * {@code
	 * new HDRImageLight(image.getResolutionX(), image.getResolutionY(), image.toFloatArray(ArrayComponentOrder.RGB), angle, scale);
	 * }
	 * </pre>
	 * 
	 * @param image an {@link ImageF} instance
	 ...
	 */
	public HDRImageLight(final ImageF image, final AngleF angle, final Vector2F scale) {
		this(image.getResolutionX(), image.getResolutionY(), image.toFloatArray(ArrayComponentOrder.RGB), angle, scale);
	}
	 ...
	 * If {@code image} is {@code null}, a {@code NullPointerException} will be thrown.
	 * <p>
	 * If either {@code resolutionX}, {@code resolutionY} or {@code resolutionX * resolutionY * 3} are less than {@code 0}, or {@code resolutionX * resolutionY * 3 != image.length}, an {@code IllegalArgumentException} will be thrown.
	 * <p>
	 * Calling this constructor is equivalent to the following:
	 * <pre>
	 * {@code
	 * new HDRImageLight(resolutionX, resolutionY, image, AngleF.degrees(0.0F));
	 * }
	 * </pre>
	 * 
	 ...
	 * @throws IllegalArgumentException thrown if, and only if, either {@code resolutionX}, {@code resolutionY} or {@code resolutionX * resolutionY * 3} are less than {@code 0}, or {@code resolutionX * resolutionY * 3 != image.length}
	 * @throws NullPointerException thrown if, and only if, {@code image} is {@code null}
	 */
	public HDRImageLight(final int resolutionX, final int resolutionY, final float[] image) {
	 ...
	 * <pre>
	 * {@code
	 * new HDRImageLight(resolutionX, resolutionY, image, angle, new Vector2F(1.0F, 1.0F));
	 * }
	 * </pre>
	 * 
	 * @param resolutionX the resolution of the X-axis
	 ...
	 * @throws NullPointerException thrown if, and only if, either {@code image} or {@code angle} are {@code null}
	 */
	public HDRImageLight(final int resolutionX, final int resolutionY, final float[] image, final AngleF angle) {
	 ...
	 * @throws NullPointerException thrown if, and only if, either {@code image}, {@code angle} or {@code scale} are {@code null}
	 */
	public HDRImageLight(final int resolutionX, final int resolutionY, final float[] image, final AngleF angle, final Vector2F scale) {
		...
		this.resolution = ParameterArguments.requireRange(resolutionX * resolutionY * 3, 0, Integer.MAX_VALUE, "resolutionX * resolutionY * 3");
		this.image = ParameterArguments.requireExactArrayLength(Objects.requireNonNull(image, "image == null"), resolutionX * resolutionY * 3, "image").clone();
	...
	/**
	 * Returns the {@link Distribution2F} instance associated with this {@code HDRImageLight} instance.
	 * 
	 * @return the {@code Distribution2F} instance associated with this {@code HDRImageLight} instance
	 */
	...
	/**
	 * Returns a {@code String} with the name of this {@code HDRImageLight} instance.
	 * 
	 * @return a {@code String} with the name of this {@code HDRImageLight} instance
	 */
	@Override
	...
	/**
	 * Returns a {@code String} representation of this {@code HDRImageLight} instance.
	 * 
	 * @return a {@code String} representation of this {@code HDRImageLight} instance
	 */
	@Override
	public String toString() {
		return String.format("new HDRImageLight(%d, %d, %s, %s, %s)", Integer.valueOf(this.resolutionX), Integer.valueOf(this.resolutionY), "new float[] {...}", this.angle, this.scale);
	}
	...
	/**
	 * Compares {@code object} to this {@code HDRImageLight} instance for equality.
	 * <p>
	 * Returns {@code true} if, and only if, {@code object} is an instance of {@code HDRImageLight}, and their respective values are equal, {@code false} otherwise.
	 * 
	 * @param object the {@code Object} to compare to this {@code HDRImageLight} instance for equality
	 * @return {@code true} if, and only if, {@code object} is an instance of {@code HDRImageLight}, and their respective values are equal, {@code false} otherwise
	 */
	@Override
	public boolean equals(final Object object) {
		if(object == this) {
			return true;
		} else if(!(object instanceof HDRImageLight)) {
			return false;
		} else if(!Objects.equals(getTransform(), HDRImageLight.class.cast(object).getTransform())) {
			return false;
		} else if(!Objects.equals(this.angle, HDRImageLight.class.cast(object).angle)) {
			return false;
		} else if(!Objects.equals(this.distribution, HDRImageLight.class.cast(object).distribution)) {
			return false;
		} else if(!Objects.equals(this.scale, HDRImageLight.class.cast(object).scale)) {
			return false;
		} else if(!equal(this.radius, HDRImageLight.class.cast(object).radius)) {
			return false;
		} else if(!Arrays.equals(this.image, HDRImageLight.class.cast(object).image)) {
			return false;
		} else if(this.resolution != HDRImageLight.class.cast(object).resolution) {
			return false;
		} else if(this.resolutionX != HDRImageLight.class.cast(object).resolutionX) {
			return false;
		} else if(this.resolutionY != HDRImageLight.class.cast(object).resolutionY) {
			return false;
		} else {
			return true;
		}
	...
	/**
	 * Returns the radius associated with this {@code HDRImageLight} instance.
	 * 
	 * @return the radius associated with this {@code HDRImageLight} instance
	 */
	...
	/**
	 * Returns an {@code int} with the ID of this {@code HDRImageLight} instance.
	 * 
	 * @return an {@code int} with the ID of this {@code HDRImageLight} instance
	 */
	@Override
	public int getID() {
		return ID;
	...
	/**
	 * Returns a hash code for this {@code HDRImageLight} instance.
	 * 
	 * @return a hash code for this {@code HDRImageLight} instance
	 */
	@Override
	public int hashCode() {
		return Objects.hash(getTransform(), this.angle, this.distribution, this.scale, Float.valueOf(this.radius), Integer.valueOf(Arrays.hashCode(this.image)), Integer.valueOf(this.resolution), Integer.valueOf(this.resolutionX), Integer.valueOf(this.resolutionY));
	}
	
	/**
	 * Returns a {@code float[]} containing the image with its colors in RGB order.
	 * <p>
	 * Modifying the returned {@code float[]} will not affect this {@code HDRImageLight} instance.
	 * 
	 * @return a {@code float[]} containing the image with its colors in RGB order
	 */
	...
	/**
	 * Loads an {@code HDRImageLight} from the file represented by {@code file}.
	 * <p>
	 * Returns a new {@code HDRImageLight} instance.
	 * <p>
	 ...
	 * <pre>
	 * {@code
	 * HDRImageLight.load(file, AngleF.degrees(0.0F));
	 * }
	 * </pre>
	 * 
	 * @param file a {@code File} that represents the file to load from
	 * @return a new {@code HDRImageLight} instance
	 * @throws NullPointerException thrown if, and only if, {@code file} is {@code null}
	 * @throws UncheckedIOException thrown if, and only if, an I/O error occurs
	 */
	public static HDRImageLight load(final File file) {
	 ...
	 * <pre>
	 * {@code
	 * HDRImageLight.load(file, angle, new Vector2F(1.0F, 1.0F));
	 * }
	 * </pre>
	 * 
	 * @param file a {@code File} that represents the file to load from
	 ...
	 * @throws UncheckedIOException thrown if, and only if, an I/O error occurs
	 */
	public static HDRImageLight load(final File file, final AngleF angle) {
	 ...
	 * @throws UncheckedIOException thrown if, and only if, an I/O error occurs
	 */
	public static HDRImageLight load(final File file, final AngleF angle, final Vector2F scale) {
		return new HDRImageLight(FloatImageF.load(file), angle, scale);
	}
	
	/**
	 * Loads an {@code HDRImageLight} from the file represented by {@code pathname}.
	 * <p>
	 * Returns a new {@code HDRImageLight} instance.
	 * <p>
	 ...
	 * <pre>
	 * {@code
	 * HDRImageLight.load(pathname, AngleF.degrees(0.0F));
	 * }
	 * </pre>
	 * 
	 ...
	 * @throws UncheckedIOException thrown if, and only if, an I/O error occurs
	 */
	public static HDRImageLight load(final String pathname) {
	 ...
	 * <pre>
	 * {@code
	 * HDRImageLight.load(pathname, angle, new Vector2F(1.0F, 1.0F));
	 * }
	 * </pre>
	 * 
	 * @param pathname a {@code String} that represents the pathname to the file to load from
	 ...
	 * @throws UncheckedIOException thrown if, and only if, an I/O error occurs
	 */
	public static HDRImageLight load(final String pathname, final AngleF angle) {
	 ...
	 * @throws UncheckedIOException thrown if, and only if, an I/O error occurs
	 */
	public static HDRImageLight load(final String pathname, final AngleF angle, final Vector2F scale) {
	...
	private Color3F doGetColorRGB(final int x, final int y) {
		final int index = (positiveModulo(y, this.resolutionY) * this.resolutionX + positiveModulo(x, this.resolutionX)) * 3;
		
		final float r = this.image[index + 0];
		final float g = this.image[index + 1];
		final float b = this.image[index + 2];
