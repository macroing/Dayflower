...
/**
 * A {@code TorranceSparrowReflectionBRDF} is an implementation of {@link BXDF} that represents a BRDF (Bidirectional Reflectance Distribution Function) for Torrance-Sparrow reflection using a microfacet distribution.
 * <p>
...
public final class TorranceSparrowReflectionBRDF extends BXDF {
	...
	/**
	 * Constructs a new {@code TorranceSparrowReflectionBRDF} instance.
	 * <p>
...
//		PBRT: Implementation of MicrofacetReflection.
	...
	/**
	 * Returns a {@code String} representation of this {@code TorranceSparrowReflectionBRDF} instance.
	 * 
	 * @return a {@code String} representation of this {@code TorranceSparrowReflectionBRDF} instance
	 */
	@Override
	public String toString() {
		return String.format("new TorranceSparrowReflectionBRDF(%s, %s, %s)", this.reflectanceScale, this.fresnel, this.microfacetDistribution);
	}
	
	/**
	 * Compares {@code object} to this {@code TorranceSparrowReflectionBRDF} instance for equality.
	 * <p>
	 * Returns {@code true} if, and only if, {@code object} is an instance of {@code TorranceSparrowReflectionBRDF}, and their respective values are equal, {@code false} otherwise.
	 * 
	 * @param object the {@code Object} to compare to this {@code TorranceSparrowReflectionBRDF} instance for equality
	 * @return {@code true} if, and only if, {@code object} is an instance of {@code TorranceSparrowReflectionBRDF}, and their respective values are equal, {@code false} otherwise
	 */
	@Override
	public boolean equals(final Object object) {
		if(object == this) {
			return true;
		} else if(!(object instanceof TorranceSparrowReflectionBRDF)) {
			return false;
		} else if(!Objects.equals(this.reflectanceScale, TorranceSparrowReflectionBRDF.class.cast(object).reflectanceScale)) {
			return false;
		} else if(!Objects.equals(this.fresnel, TorranceSparrowReflectionBRDF.class.cast(object).fresnel)) {
			return false;
		} else if(!Objects.equals(this.microfacetDistribution, TorranceSparrowReflectionBRDF.class.cast(object).microfacetDistribution)) {
			return false;
		} else {
			return true;
		}
...
//		PBRT: Implementation of MicrofacetReflection.
	...
	/**
	 * Returns a hash code for this {@code TorranceSparrowReflectionBRDF} instance.
	 * 
	 * @return a hash code for this {@code TorranceSparrowReflectionBRDF} instance
	 */
	@Override
	public int hashCode() {
