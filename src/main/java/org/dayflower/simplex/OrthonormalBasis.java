...
//	TODO: Add Javadocs!
	public static double[] orthonormalBasis33DTransformMatrix44D(final double[] matrix44DLHS, final double[] orthonormalBasis33DRHS) {
		return orthonormalBasis33DTransformMatrix44D(matrix44DLHS, orthonormalBasis33DRHS, orthonormalBasis33D());
	}
	
//	TODO: Add Javadocs!
	public static double[] orthonormalBasis33DTransformMatrix44D(final double[] matrix44DLHS, final double[] orthonormalBasis33DRHS, final double[] orthonormalBasis33DResult) {
		return orthonormalBasis33DTransformMatrix44D(matrix44DLHS, orthonormalBasis33DRHS, orthonormalBasis33DResult, 0, 0, 0);
	}
	
//	TODO: Add Javadocs!
	public static double[] orthonormalBasis33DTransformMatrix44D(final double[] matrix44DLHS, final double[] orthonormalBasis33DRHS, final double[] orthonormalBasis33DResult, final int matrix44DLHSOffset, final int orthonormalBasis33DRHSOffset, final int orthonormalBasis33DResultOffset) {
		...
		vector3DTransformMatrix44D(matrix44DLHS, vector3DU, vector3DU, matrix44DLHSOffset, 0, 0);
		vector3DTransformMatrix44D(matrix44DLHS, vector3DV, vector3DV, matrix44DLHSOffset, 0, 0);
		vector3DTransformMatrix44D(matrix44DLHS, vector3DW, vector3DW, matrix44DLHSOffset, 0, 0);
		
		vector3DNormalize(vector3DU, vector3DU, 0, 0);
		vector3DNormalize(vector3DV, vector3DV, 0, 0);
		vector3DNormalize(vector3DW, vector3DW, 0, 0);
		
		return orthonormalBasis33DSet(orthonormalBasis33DResult, vector3DU, vector3DV, vector3DW, orthonormalBasis33DResultOffset, 0, 0, 0);
	}
	
//	TODO: Add Javadocs!
	public static double[] orthonormalBasis33DTransformTransposeMatrix44D(final double[] matrix44DLHS, final double[] orthonormalBasis33DRHS) {
		return orthonormalBasis33DTransformTransposeMatrix44D(matrix44DLHS, orthonormalBasis33DRHS, orthonormalBasis33D());
	}
	
//	TODO: Add Javadocs!
	public static double[] orthonormalBasis33DTransformTransposeMatrix44D(final double[] matrix44DLHS, final double[] orthonormalBasis33DRHS, final double[] orthonormalBasis33DResult) {
		return orthonormalBasis33DTransformTransposeMatrix44D(matrix44DLHS, orthonormalBasis33DRHS, orthonormalBasis33DResult, 0, 0, 0);
	}
	
//	TODO: Add Javadocs!
	public static double[] orthonormalBasis33DTransformTransposeMatrix44D(final double[] matrix44DLHS, final double[] orthonormalBasis33DRHS, final double[] orthonormalBasis33DResult, final int matrix44DLHSOffset, final int orthonormalBasis33DRHSOffset, final int orthonormalBasis33DResultOffset) {
		final double[] vector3DU = orthonormalBasis33DGetU(orthonormalBasis33DRHS, vector3D(), orthonormalBasis33DRHSOffset, 0);
		final double[] vector3DV = orthonormalBasis33DGetV(orthonormalBasis33DRHS, vector3D(), orthonormalBasis33DRHSOffset, 0);
		final double[] vector3DW = orthonormalBasis33DGetW(orthonormalBasis33DRHS, vector3D(), orthonormalBasis33DRHSOffset, 0);
		
		vector3DTransformTransposeMatrix44D(matrix44DLHS, vector3DU, vector3DU, matrix44DLHSOffset, 0, 0);
		vector3DTransformTransposeMatrix44D(matrix44DLHS, vector3DV, vector3DV, matrix44DLHSOffset, 0, 0);
		vector3DTransformTransposeMatrix44D(matrix44DLHS, vector3DW, vector3DW, matrix44DLHSOffset, 0, 0);
