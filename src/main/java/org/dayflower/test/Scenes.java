...
//		final Material material2 = new PlasticMaterial(new ConstantTexture(new Color3F(2.0F, 0.25F, 0.25F)), new ConstantTexture(new Color3F(0.1F)), new ConstantTexture(new Color3F(0.25F)), true);
		final Material material2 = new MetalMaterial(new ConstantTexture(colorCopperN), new ConstantTexture(colorCopperK), new ConstantTexture(new Color3F(0.01F)), new ConstantTexture(new Color3F(0.01F)), true);
