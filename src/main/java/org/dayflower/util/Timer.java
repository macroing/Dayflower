...
public final class Timer {
	 ...
	 * <p>
	 * Calling this method is equivalent to {@code getMilliseconds(System.currentTimeMillis())}.
	 * 
	...
	/**
	 * Returns the milliseconds that have passed between the time at which this {@code Timer} instance was started or restarted and {@code milliseconds}.
	 * 
	 * @param milliseconds the milliseconds to measure to
	 ...
	 * <p>
	 * Calling this method is equivalent to {@code getMillisecondsRemaining(System.currentTimeMillis())}.
	 * 
	...
	/**
	 * Returns the milliseconds that have passed between the time at which this {@code Timer} instance was started or restarted and {@code milliseconds}, excluding the milliseconds that are represented by full hours, minutes and seconds.
	 * 
	 * @param milliseconds the milliseconds to measure to
