...
//	TODO: Add Unit Tests!
	...
	/**
	 * Returns the {@code float} representation of the {@code double} value that is closest in value to the argument and is equal to a mathematical integer.
	 * <p>
...
//	TODO: Add Unit Tests!
	public static float rint(final float value) {
		return toFloat(Math.rint(value));
	}
