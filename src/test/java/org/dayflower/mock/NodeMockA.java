...
public final class NodeMockA implements Node {
	...
	public NodeMockA(final String string) {
		this(string, new ArrayList<>());
	}
	
	public NodeMockA(final String string, final List<Node> nodes) {
		this(string, nodes, false);
	}
	
	public NodeMockA(final String string, final List<Node> nodes, final boolean isThrowingRuntimeException) {
	...
	public boolean equals(final Object object) {
		if(object == this) {
			return true;
		} else if(!(object instanceof NodeMockA)) {
			return false;
		} else if(!Objects.equals(this.nodes, NodeMockA.class.cast(object).nodes)) {
			return false;
		} else if(!Objects.equals(this.string, NodeMockA.class.cast(object).string)) {
			return false;
		} else if(this.isThrowingRuntimeException != NodeMockA.class.cast(object).isThrowingRuntimeException) {
			return false;
		} else {
			return true;
		}
